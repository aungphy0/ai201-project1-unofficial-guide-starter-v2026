...
```
You should start looking earlier than feels reasonable, as large employers close their applications in October and November for the following summer. (Source: `thread_internship_timing.txt`)
```
...
```
Students recommend 16GB of RAM for a laptop for CS courses (thread_laptop_specs.txt).
```
...
```
Students recommend getting 16GB of RAM for a laptop for CS courses. 
...
```
For most people (everywhere except Fenwick, which has kitchenettes), students recommend getting the middle tier. 
...
```
For most people living outside of Fenwick (which has kitchenettes), students recommend getting the middle tier meal plan. 
